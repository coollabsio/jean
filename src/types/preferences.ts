...
export interface AppPreferences {
  ...
  wsl_mode_chosen: boolean // Whether WSL mode selection has been made
  wsl_enabled: boolean // Route supported commands through WSL
  wsl_distro: string // WSL distro name
}
