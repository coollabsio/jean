...
const paneEntries: PreferenceSearchEntry[] = [
  ...
  },
  {
    ...
    keywords: ['kimi', 'kimi code', 'moonshot', 'kimi model'],
  ...
  },
  {
    ...
    paneTitle: 'Devin',
    type: 'pane',
    title: 'Devin Settings',
    keywords: ['devin', 'devin cli', 'devin model', 'cognition'],
    anchorId: 'pref-pane-devin',
  },
  {
    id: 'pane-github',
    pane: 'github',
...
const sectionEntries: PreferenceSearchEntry[] = [
  ...
  },
  {
    ...
    title: 'Grok CLI',
    sectionTitle: 'Grok',
    keywords: ['grok', 'install grok', 'grok login', 'grok source', 'xai'],
    anchorId: 'pref-grok-section-cli',
    fallbackAnchorId: 'pref-pane-grok',
  },
  {
    id: 'grok-settings',
    pane: 'grok',
  ...
  },
  {
    ...
    keywords: ['kimi', 'install kimi', 'kimi login', 'kimi source', 'moonshot'],
  ...
  },
  {
    ...
    title: 'Devin CLI',
    sectionTitle: 'CLI source',
    keywords: ['devin', 'install devin', 'devin login', 'devin source'],
    anchorId: 'pref-devin-section-cli',
    fallbackAnchorId: 'pref-pane-devin',
  },
  {
    id: 'devin-settings',
    pane: 'devin',
    ...
    title: 'Devin Model',
    sectionTitle: 'Default model',
    keywords: ['devin model', 'devin default model'],
