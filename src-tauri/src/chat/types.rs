...
mod backend_tests {
    ...
    #[test]
    fn backend_deserializes_claude_default() {
        let backend: Backend = serde_json::from_str("\"claude\"").unwrap();
...
pub struct Session {
    ...
    /// Antigravity session ID for resuming conversations
    #[serde(default)]
...
pub struct RunEntry {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub grok_session_id: Option<String>,
    /// Antigravity session ID — persisted per-run for conversation continuity.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub antigravity_session_id: Option<String>,
}
